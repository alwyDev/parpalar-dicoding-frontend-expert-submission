...
describe('Liking A Restaurant', () => {
  ...
  it('should be able to like the restaurant', async () => {
    ...
    const restaurant = await FavoriteRestaurantDicoding.getRestaurant(1)

    expect(restaurant).toEqual({ id: 1 })

    FavoriteRestaurantDicoding.deleteRestaurant(1)
  })
  ...
  it('should not add a restaurant again when its already liked', async () => {
    ...
    expect(await FavoriteRestaurantDicoding.getAllRestaurants()).toEqual([{ id: 1 }])
